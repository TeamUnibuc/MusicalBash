...
BASH_COUNT = how_many_str
SHOW_HOW_MANY = echo "Recompiled: $${$(BASH_COUNT)}"
ADD_COMPILE = $(BASH_COUNT)="$${$(BASH_COUNT)}X"

INITIALIZE:=$(shell $(SHOW_HOW_MANY))
...
.PHONY: showStats addCompile showCompile
showStats:
	$(SHOW_HOW_MANY)
