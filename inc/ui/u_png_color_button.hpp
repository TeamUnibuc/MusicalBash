 ...
 */
class PngColorButton : public ColorButton, public ObjUpdater<sf::Color>
{
protected:
...
public:
    PngColorButton(int szX, int szY, UniquePtr<Command> cPtr, sf::Color normal, sf::Color hover,
                   SharedPtr<PngSprite> pngPtr, std::function<void(sf::Color&)> func = ObjUpdater<sf::Color>::kDefault);
